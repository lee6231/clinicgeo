    ...
    <form onSubmit={handleSubmit} className="relative overflow-hidden rounded-lg border border-[#e8cfd8] bg-[#fffaf4] shadow-[0_24px_70px_rgba(93,73,82,0.13)]" noValidate>
      ...
      <div className="relative border-b border-blue-100 px-6 py-6 sm:px-8">
        <div className="flex items-start justify-between gap-5">
          <div>
            <h3 className="text-lg font-bold text-[#3b2934] sm:text-xl">상담 정보 입력</h3>
            <p className="mt-1 text-sm leading-6 text-[#78646e]">확인에 필요한 기본 정보만 간단히 입력해 주세요.</p>
          </div>
          <span className="shrink-0 border-l-2 border-[#d26383] pl-3 text-[11px] font-bold text-[#95445f]">4개 항목</span>
        </div>
      </div>
      ...
      <div className="relative border-t border-blue-100 bg-[#fff4f7] px-6 py-5 sm:px-8">
        ...
        {message && (
          <p role="status" className={`mt-4 rounded-md border px-4 py-3 text-sm leading-6 ${status === "success" ? "border-blue-200 bg-white text-[#3b2934]" : "border-red-200 bg-red-50 text-red-800"}`}>
