...
export const metadata: Metadata = buildMetadata(
  ...
  "광고·제휴 및 이해관계 안내",
  "Clinic GEO의 유료 광고, 제휴, 정보 제공과 써밋피드 운영 관계의 표시 방식을 안내합니다.",
);
...
const labels = [
  ...
  ["운영 관계", "Clinic GEO와 운영 또는 사업상 이해관계가 있는 경우"],
];
    ...
    <PageFrame>
      <main>
        <PageIntro
          ...
          description="일반 편집 정보와 광고·제휴를 구분하고, 콘텐츠 대상과 운영 관계가 있을 때 독자가 바로 확인할 수 있도록 표시합니다."
        >
          <DisclosureNotice />
        </PageIntro>
        <section className="mx-auto max-w-5xl px-5 py-14 sm:px-6">
          ...
          <div className="mt-12 space-y-10">
            <section>
              <h2 className="text-2xl font-bold">써밋피드와 Clinic GEO의 관계</h2>
              <p className="mt-4 text-sm leading-8 text-slate-600">
                Clinic GEO는 써밋피드(SUMMITFEED)와 운영 또는 사업상 이해관계가 있습니다. 써밋피드 또는
                관련 서비스를 언급하는 콘텐츠에는 운영 관계를 표시합니다. 이 표시는 써밋피드의 서비스가
                다른 서비스보다 우월하거나 더 효과적이라는 의미가 아닙니다.
              </p>
            </section>
            <section>
