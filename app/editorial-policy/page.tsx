...
const policies = [
  ...
  ["광고·제휴 구분", "광고, 제휴, 정보 제공, 편집 후보와 기타 이해관계를 텍스트 라벨로 구분합니다. 경제적 이해관계가 있으면 콘텐츠 상단과 하단에 표시합니다."],
  ["독립 운영 원칙", "Clinic GEO는 콘텐츠에서 언급하는 병원·업체·대행사와 별도로 운영됩니다. 외부 업체 언급이나 링크는 운영 관계를 의미하지 않습니다."],
